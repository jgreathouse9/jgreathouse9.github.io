...
This will be a short blog post. I've spent the last two months doing a little industry work in the marketing realm, and in the meantime I have made some substantial changes to ```mlsynth```. This blog post simply shows one of the new key features I have implemented.
