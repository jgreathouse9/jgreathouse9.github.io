...
T0_RMSE_RSC = arco["RSC"]["Fit"].get("T0 RMSE", None)
T0_RMSE_RPCASC = arco["RPCASC"]["Fit"].get("T0 RMSE", None)

# Extract ATT and Percent ATT from the Effects dictionary
ATT_RSC = arco["RSC"]["Effects"].get("ATT", None)
ATT_RPCASC = arco["RPCASC"]["Effects"].get("ATT", None)

Percent_ATT_RSC = arco["RSC"]["Effects"].get("Percent ATT", None)
Percent_ATT_RPCASC = arco["RPCASC"]["Effects"].get("Percent ATT", None)
