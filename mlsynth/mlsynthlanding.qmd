...
**Contributors**: [Jared Greathouse](https://jgreathouse9.github.io")
...
1. Here are [my intro to SCM slides)[https://jgreathouse9.github.io/qprez/scmintro.html#/title-slide), which uses `mlsynth` under the hood. 
