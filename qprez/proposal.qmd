...
- Outcomes depend almost entirely on:
  - Government action
  - Collective behavior
...
- Spillovers violate core assumptions of:
  ...
  - Panel data designs relying on cross-sectional groups of controls
...
- The issue is not *which* controls to use, but whether any valid ones exist
...
- When exposure is ubiquitous:
  - Contemporaneous control groups are likely not credible
  - Spillovers cannot be instrumental for
  - Standard designs lose interpretability

- Credible inference must (where appropriate):
