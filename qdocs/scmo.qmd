...
Sometimes, analysts have multiple different metrics at their disposal with which to estimate synthetic control models. That is, multiple relevant variables may predict a target/outcome variable that we care about, and [plenty](https://doi.org/10.1016/j.ecosta.2017.08.002) of other papers have commented on this fact before. Some analysts even argue for [the surrogate approach](https://proceedings.mlr.press/v238/liu24a/liu24a.pdf), where we treat other outcomes or affected units as a kind of instrument for the counterfactual trajcectory of the target unit.
