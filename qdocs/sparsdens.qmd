...
As we can see, both the sparse and dense models perform about the same, despite the clear differneces in the models themselves. THe sparse model average is not far off from the dense model average, and their predictions/ATTs are quite similar.
