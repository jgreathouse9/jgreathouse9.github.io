...
$$
q_{1-\alpha} = \inf \Big\{ q \in \mathbb{R} \;\Big|\; 
\frac{1}{T_0} \sum_{t \in \mathcal{T}_1} \mathbf{1}(|e_t| \le q) \ge 1-\alpha \Big\}.
$$
...
$$
\text{CI}_t = \big[ \hat{\tau}_{1t} - q_{1-\alpha}, \; \hat{\tau}_{1t} + q_{1-\alpha} \big], 
\quad t \in \mathcal{T}_2.
$$
