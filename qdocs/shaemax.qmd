...
\left\{ \mathbf{w} \in \mathbb{R}^{|\mathcal{N}_0|} : 0 \leq w_j \leq 1 \;\; \forall j \right\}
$$

$$
\mathcal{C}_{\text{simplex}} := 
\left\{ \mathbf{w} \in \mathbb{R}^{|\mathcal{N}_0|} : \mathbf{w} \geq \mathbf{0},\; \mathbf{1}^\top \mathbf{w} = 1 \right\}
$$

$$
\mathcal{C}_{\text{affine}} := 
\left\{ \mathbf{w} \in \mathbb{R}^{|\mathcal{N}_0|} : \mathbf{1}^\top \mathbf{w} = 1 \right\}
$$

$$
\mathcal{C}_{\text{nonneg}} := 
\left\{ \mathbf{w} \in \mathbb{R}^{|\mathcal{N}_0|} : \mathbf{w} \geq \mathbf{0} \right\}
$$

$$
\mathcal{C}_{\text{unconstrained}} := 
\left\{ \mathbf{w} \in \mathbb{R}^{|\mathcal{N}_0|} \right\}
$$
