...
- Many high-stakes policies create data environments where:
  - Treatments are nationwide or isolated
  - Adoption is staggered
  - Valid geographic controls do not exist
- These settings strain or invalidate traditional empirical tools
...
- Mandatory 14-day quarantine on *all* arrivals (March 26, 2020)
...
- No credible untreated comparison units
- Standard DiD and SCM designs fail
...
- Using weighted combinations of:
  - Earlier historical segments
- Learn how Hawaii typically evolves
...
- Monthly time series
- ~30 years of pre-treatment data
- Sources:
  - Hawaii DBEDT
  - FRED
...
4. Predict post-treatment counterfactual
...
- Uses Synthetic Historical Control (SHC):
...
Each implemented vaccine mandates for indoor dining in 2021.
