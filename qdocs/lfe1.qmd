...
Okay so now with the residuals neatly defined, we can begin. We are interested in finding the weight $w_1$ that minimizes the sum of squared residuals between the treated unit and a convex combination of the donor units:
