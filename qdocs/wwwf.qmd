---
title: "What Are We Weighting For? It Depends on Your Objective"
date: 2025-08-25
...
&=
\begin{bmatrix}
(12 \times {\color{red}\frac{1}{3}}) + (14 \times {\color{blue}\frac{1}{3}}) + (13 \times {\color{purple}\frac{1}{3}}) \\
(15 \times {\color{red}\frac{1}{3}}) + (16 \times {\color{blue}\frac{1}{3}}) + (15 \times {\color{purple}\frac{1}{3}}) \\
(18 \times {\color{red}\frac{1}{3}}) + (20 \times {\color{blue}\frac{1}{3}}) + (19 \times {\color{purple}\frac{1}{3}}) \\
(17 \times {\color{red}\frac{1}{3}}) + (18 \times {\color{blue}\frac{1}{3}}) + (17 \times {\color{purple}\frac{1}{3}}) \\
(19 \times {\color{red}\frac{1}{3}}) + (21 \times {\color{blue}\frac{1}{3}}) + (20 \times {\color{purple}\frac{1}{3}}) \\
\end{bmatrix} \\
&=
\begin{bmatrix}
4 + 4.67 + 4.33 \\
...
This is a non-uniformly weighted average that leans more heavily on Hotel B. The weighted average is then:
...
In the extreme case, we can assign all the weight to a single hotel. Suppose we give all the weight to Hotel B (the second column), and none to Hotels A and C:
