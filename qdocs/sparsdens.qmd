...
To be more specific, let's use a real example.
...
Consider this plot of a growth rate variable, where the outcome is number of products purchased when some advertising campaigns went into effect. The goal of an incrementality study would be to estimate how the growth of the sales would have evolved absent the ads (after all, this is how we know if we're wasting money or not, by estimating how much we would've made if we just didn't do our ad spend at all).
