...
$$
S_{\text{obs}} = \frac{1}{|\mathcal{T}_1|} \sum_{t \in \mathcal{T}_2} \big|\hat{\tau}_{t}\big|.
$$

We form a permutation distribution by pooling the placebo effects $\{\hat{\tau}_{t}^{\mathcal{B}} : t \in \mathcal{B}\}$ and post-treatment effects $\{\hat{\tau}_{t} : t \in \mathcal{T}_2\}$, then repeatedly sampling subsets of size $|\mathcal{T}_1|$ to compute:
