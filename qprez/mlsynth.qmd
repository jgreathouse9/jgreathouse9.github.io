...
For SCM, we have  
$$
\underset{\mathbf{w} \in \mathbb{I}^{N_0}}{\operatorname*{argmin}} \lVert \mathbf{y}_1 - \mathbf{w}^\top \mathbf{Y}_0 \rVert_2^2,  \: \forall \: t \in \mathcal{T}_{1}, \: \text{s.t. } \lVert \mathbf{w} \rVert_1 = 1.
$$

For DID, we have

$$
\underset{\mathbf{w}^{N_0}}{\operatorname*{argmin}} \lVert \mathbf{y}_1 - \mathbf{w}^\top \mathbf{Y}_0- \boldsymbol{\beta}_0 \rVert_2^2,  \: \forall \: t \in \mathcal{T}_{1}, \: \text{s.t. } \lVert \mathbf{w}= \frac{1}{N_0}.
$$ 
