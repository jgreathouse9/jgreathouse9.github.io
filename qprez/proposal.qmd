...
- Pandemics like COVID-19 are not individual-level risks
- Exposure is:
  - Non-optional
  - Non-local
...
- Throughout the pandemic, policymakers faced a fundamental tradeoff:
  - Mitigating public health risks
  - Preserving economic and social well-being

- Non-pharmaceutical interventions (NPIs) were designed to:
  - Reduce transmission
  - Prevent health system collapse

- But these policies also raised concerns about:
  - Employment and income losses
  - Tourism and service-sector activity
  - Broader economic disruption

## What the Literature Emphasizes — and What It Misses

- A large literature studies health impacts of pandemic policies:
  - [Mobility restrictions and case growth](https://arxiv.org/pdf/2005.00072)
  - [School reopenings and transmission](https://doi.org/10.1093/haschl/qxaf233)
  - [Sporting events](https://doi.org/10.1073/pnas.2114226119), mass gatherings, and infection rates

- Far less is known about secondary economic outcomes:
  - Short-run economic costs of aggressive containment
  - Distributional impacts across sectors and regions
  - Tradeoffs between health protection and economic activity

- As a result:
  - Policymakers have limited evidence on whether interventions can
    *protect public health without severe economic harm*
...
- As a result:
  - Geographic controls are usually partly contaminated
