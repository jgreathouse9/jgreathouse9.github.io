...
- Much of what economists do is predicated on interventions affecting some set of outcomes.

- Methods such as Difference-in-Differences and Synthetic Control Methods (DID and SCM) are often used to measure causal impacts.
