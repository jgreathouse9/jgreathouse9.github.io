...
$$
\mathbb{E}[y_{1t}(0)] - \mathbb{E}[y_{\mathcal{N}_0 t}(0)] = \mathbb{E}[y_{1t-1}(0)] - \mathbb{E}[y_{\mathcal{N}_0 t-1}(0)]
$$

Li's PTA is

$$
\mathbb{E}[y_{1t}(0) \mid U] - \mathbb{E}[y_{Ut}(0) \mid U] = \mathbb{E}[y_{1t-1}(0) \mid U] - \mathbb{E}[y_{Ut-1}(0) \mid U] = \alpha_U, \quad t = 2, \dots, T
$$
