...
- **Linear factor model** (optional): The treated unit's outcomes can be represented as a function of observed covariates and latent factors that remain stable pre and post treatment:

  $$
  \mathbf{y}_1 = \boldsymbol{\delta} + \mathbf{Z} \boldsymbol{\theta} + \boldsymbol{\Lambda} \boldsymbol{\mu} + \boldsymbol{\varepsilon}
  $$
