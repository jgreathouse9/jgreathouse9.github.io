...
- SCM constrains our weights to be on the simplex,  
  $$
  \Delta \operatorname{:=} \{\mathbf{w} \in \mathbb{R}_{\geq 0}^{N_0} \mid \lVert \mathbf{w} \rVert_1 = 1\}.
  $$  
  The optimization to learn the weights is  
  $$
