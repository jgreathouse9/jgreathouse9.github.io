...
- This is mathematically equivalent to dividing the sum of the entries by 2, as we did with scalars. In other words, arithmetic averaging is just taking a weighted sum where each weight is the reciprocal of the number of entries.
