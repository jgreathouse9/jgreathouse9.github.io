...
- As a result:
  ...
  - Comparisons across regions or time periods are difficult to interpret (in many cases)
  - Observed effects often conflate policy responses with broader social dynamics
...
- Credible policy analysis in these settings requires:
  - Careful construction of counterfactuals grounded in historical dynamics
  - Methods that explicitly account for spillovers and shared shocks
  - Analytical frameworks designed for system-wide interventions rather than isolated treatments
...
- Many modern causal inference methods (e.g., SHC, RESCM, augmented SCM) lack ready-to-use software

- Existing SCM tools in R, Stata, and Python:
  - Are limited in scope
  - Cannot implement novel identification strategies
