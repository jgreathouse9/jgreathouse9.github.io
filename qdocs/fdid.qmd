...
Parallel trends is formalized as 

$$
\mathbb{E}[y_{1t}(0) \mid \mathcal{N}] - \mathbb{E}[y_{\mathcal{N}t}(0) \mid \mathcal{N}] = \mathbb{E}[y_{1t-1}(0) \mid \mathcal{N}] - \mathbb{E}[y_{\mathcal{N}t-1}(0) \mid \mathcal{N}] + v_{\mathcal{N}t}, \quad t = 2, \dots, T
$$

Li's PTA is

$$
\mathbb{E}[y_{1t}(0) \mid \mathcal{U}] - \mathbb{E}[y_{\mathcal{U}t}(0) \mid \mathcal{U}] = \mathbb{E}[y_{1t-1}(0) \mid \mathcal{U}] - \mathbb{E}[y_{\mathcal{U}t-1}(0) \mid \mathcal{U}] + v_{\mathcal{U}t}, \quad t = 2, \dots, T
$$
