...
- **The impact**:
  - Run multiple SCMs in under 5 minutes with very few lines of code
...
- Several SCM advances that Tripadvisor may benefit from unfortuantely have non-trivial startup costs to using them effectively.
...
**With `mlsynth`**: Estimated three SCMs in a few minutes with very few lines of code, showing a ~12% price increase.
