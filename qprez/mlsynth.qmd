...
# Extracts study quality data
prepdict = dataprep(df, unitid, time, outcome, treat)

Nmean = np.mean(prepdict["donor_matrix"],axis=1) # Control Unit Vector
...
plt.axvline(x=time_index[prepdict["pre_periods"]], color="#7df9ff", linestyle="-", linewidth=2, label="Lockdown Date")
