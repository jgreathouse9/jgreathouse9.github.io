...
- The OLS coefficients are the weights that minimize the difference between the all of the donor units and the treated unit in the pre-intervention period.
