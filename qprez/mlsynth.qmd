...
- Many of the analysis process are not automated, leaving room for small errors.
...
- The point of the Python library ```mlsynth```, said simply, is to further democratize causal inference and econometrics, making its benefits available to a wider class of researchers.

- The Python library ```mlsynth``` automates these estimators (and more!).

- Its syntax is very simple, and almost all of the steps are totally automated.
