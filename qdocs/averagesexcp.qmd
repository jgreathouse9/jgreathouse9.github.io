...
Exploiting the fact that summation is a linear operator, it distributes over addition and allows constants to factor out. Since $\mu$ does not at all depends on $i$, it appears identically in every term of the sum
