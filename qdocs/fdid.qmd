...
Now we can import the fit the FDID model using the entire donor pool.
...
Our ATT using all donors is 12.98, and the pre-treatment $R^2= 0.853$. We can do the same with the Mediterranaean only dataframe
...
Where now the ATT is 11.64 and the $R^2=0.859$. These results may be summarized in a table
