...
- None of these methods calculates and stores the ATT/relevant fit metrics as a matter of course, this job is left up to the analyst. While these are relatively simple to compute, having to do it manually is inconvenient.

- The existing implementations also (arguably) presume a more advanced knowledge of machine-learning, econometrics, and/or programming than the modal economist, marketer, or data scientist is *likely* to have.

- This combination makes it harder/more cumbersome for applied scientist to use these methods in practice. 
...
If only there were a more user friendly, free library that brings these approaches together, with a simpler setup and syntax...
