...
*Python-native, production-ready causal inference methods for policy and business impact analysis*
...
SCMs are widely used to measure the causal effect of public policy changes or marketing interventions. However, many modern SCMs are *practically* hard to use due to technical debt.
