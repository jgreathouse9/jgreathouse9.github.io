...
results = {
    ...
    "FDID": [
        arco[0]["FDID"]["Effects"].get("ATT", None),
        arco[0]["FDID"]["Fit"].get("T0 RMSE", None),
        arco[0]["FDID"]["Effects"].get("Percent ATT", None)
    ],
    "DID": [
        arco[1]["DID"]["Effects"].get("ATT", None),
        arco[1]["DID"]["Fit"].get("T0 RMSE", None),
        arco[1]["DID"]["Effects"].get("Percent ATT", None)
    ]
}
