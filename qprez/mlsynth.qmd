...
$$
\begin{aligned}
    \underset{\mathbf{w} \in \mathbb{R}^{N_0}}{\operatorname*{argmin}} &\quad \lVert \mathbf{y}_1 - \mathbf{Y}_0 \mathbf{w} \rVert_2^2, \\
    \text{s.t.} &\quad \Delta \operatorname{:=} \{\mathbf{w} \in \mathbb{R}_{\geq 0}^{N_0}, \: \lVert \mathbf{w} \rVert_1 = 1\}.
\end{aligned}
$$
