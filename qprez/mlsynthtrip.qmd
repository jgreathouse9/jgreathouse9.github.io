...
- **The solution**: `mlsynth` — a lightweight Python library unifying over 20 SCMs under one consistent grammar, easily integrated with Tripadvisor’s data science team.

- **The impact**:
  - Run multiple SCMs in a few minutes minutes with less than 40 lines of code
...
**Tripadvisor impact**: Manual/ad-hoc processes in Python/R slow implementation SCMs for business relvant use cases.
...
## The Solution is to Travel Lightly, with `mlsynth`
...
- **Post-Treatment Period**: July 1st 2015 To Week 34 of 2017.
...
This code estimates three SCMs using `mlsynth`.
...
This chart shows the moratorium’s ~12% price increase.
