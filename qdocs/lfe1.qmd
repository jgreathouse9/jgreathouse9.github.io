...
plt.plot(t, y, 'r-o', label=r'$\mathbf{y}$', linewidth=2, label="Treated Unit")
plt.plot(t, y1, 'b-o', label=r'$\mathbf{y}_1$', linewidth=2,  label="Donor 1")
plt.plot(t, y2, 'g-o', label=r'$\mathbf{y}_2$', linewidth=2,  label="Donor 2")

plt.xlabel('Time')
plt.ylabel('Value')
plt.title('Time Series Plot')
plt.xticks(t)  # Show integer time steps
plt.legend()
plt.grid(True)
plt.show()
```
...
Calculus is the heart of SCM, which is unsurprising given that it's an optimization problem. However, after years of reading about SCM, I've never ever seen somebody solve a simple synthetic control by hand. I do this below.
