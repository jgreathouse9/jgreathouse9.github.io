...
$$
where $\mathbf{U}_r$ consists of the first $r$ columns of $\mathbf{U}$ and $\mathbf{\Sigma}_r$ is the truncated diagonal matrix containing the top $r$ singular values.
