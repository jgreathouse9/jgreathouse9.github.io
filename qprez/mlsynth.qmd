...
SCM takes the form of
$$
\underset{\mathbf{w} \in \mathbb{R}^{N_0}}{\operatorname*{argmin}} \lVert \mathbf{y}_1 - \mathbf{Y}_0 \mathbf{w} \rVert_2^2, 
$$
s.t.
$$
\mathbf{w} \in \mathbb{R}_{\geq 0}^{N_0}, \quad \lVert \mathbf{w} \rVert_1 = 1.
$$

For DID, we have

$$
\underset{\mathbf{w} \in \mathbb{R}^{N_0}}{\operatorname*{argmin}} \lVert \mathbf{y}_1 - \mathbf{Y}_0 \mathbf{w} - \boldsymbol{\beta}_0 \rVert_2^2, 
$$
s.t.
$$
\mathbf{w} = \frac{1}{N_0} \mathbf{1}_{N_0}.
$$
