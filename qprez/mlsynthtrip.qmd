...
- **The impact**:
  - Analysts using `mlsynth` may estimate multiple SCMs in a few minutes with no change to their data and small changes to syntax.
  - Seamlessly integrate `mlsynth` into CI/CD pipelines for automated geo-testing
