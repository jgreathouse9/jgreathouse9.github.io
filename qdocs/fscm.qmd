...
This process continues for the rest of the donor pool. For $K=2$, we see which set of two donor units, the first one included, minimizes the $\text{MSE}$. As before, this becomes our second donor unit and MSE selected
