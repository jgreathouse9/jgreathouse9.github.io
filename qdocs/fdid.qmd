...
When might these be useful in business science such as construction or in tourism? Well for one, [lots of](https://www.constructiondive.com/news/heat-laws-construction-water-breaks-safety/716883/) [states](https://www.npr.org/2024/04/12/1244316874/florida-blocks-heat-protections-for-workers-right-before-summer) have passed laws regarding heat safety for workers which restrict local areas from passing laws which would provide workers with water, shade, and rest in the hot summer months. If tourism is a concern, we can use causal inference to estimate the impact of events that are meant to affect the demand for tourism or the physical building of construction units (which could, in some cases, affect put-in-place value or other relvant metrics in some markets). Equally, we may quantify the effects of policies such as [tariffs](https://www.constructiondive.com/news/contractors-brace-steel-aluminum-tariff-impacts/740119/) on the costs of materials, hotel demand, or other industry relevant instances. With proper causal infernece, firms and policymakers may better plan and take action with scientifically based analysis.
