...
- **Good pre-treatment fit is essential**: SCM relies on the treated unit being well approximated by a weighted combination of donors before the intervention.   

- **SUTVA (no interference)**: The potential outcome of the treated unit should not be affected by the treatment of other units.  
...
- **No anticipation:** The treated unit does not adjust its behavior before the intervention in anticipation of treatment.
