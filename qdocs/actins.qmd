...
plt.plot(time_points, cf_final, label="Model-Averaged Counterfactual", linestyle="-", color="red", linewidth=2)

# Mark the intervention point
plt.axvline(x=num_pre_periods - 1, color="blue", linestyle="--", label="Uber Green")
