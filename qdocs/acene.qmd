...
Since the time difference is identical for both groups, this means that absent the treatment, the difference between the treatment unit and the control unit would be some constant.
