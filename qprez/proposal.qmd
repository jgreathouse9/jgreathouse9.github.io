...
- Pandemics differ from most policy contexts in **scale and scope**  
- COVID-19 was a **global shock**, affecting:
  - All regions simultaneously
  - Multiple economic and social systems at once
- Individual mitigation is limited:
  - Outcomes depend heavily on **public policy and government intervention**

- As a result, COVID-19 policy responses provide a **critical test case** for causal inference in high-stakes settings

## Why Pandemics Create Identification Challenges

- **Spillovers are inherent**:
  - Travel, migration, supply chains, and information flows link regions
  - Policies in one place affect outcomes elsewhere

- **No truly untreated units**:
  - Nearly all geographic units are exposed to the disease
  - Policy timing may differ, but exposure does not

- **Geographic controls are implausible**:
  - Hard to argue any region is both:
    - A valid comparator in principle, and
    - Sufficiently unaffected to serve as a control

- Standard DiD and SCM assumptions are strained or violated

## COVID-19 as a Methodological Stress Test

- Pandemic policies highlight core weaknesses of traditional designs:
  - Reliance on untreated donor pools
  - Assumptions of limited spillovers
  - Sensitivity to global shocks

- These settings demand methods that:
  - Do **not require contemporaneous controls**
  - Can accommodate **system-wide interventions**
  - Remain credible under pervasive spillovers

- This motivates the use of **machine-learning–augmented causal methods**, such as:
  - Synthetic Historical Control
  - Augmented SCM and panel methods
