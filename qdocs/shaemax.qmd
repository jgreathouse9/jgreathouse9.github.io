...
for rtype in relax_types:
    print(f"Running RELAXED SCM ({rtype})")
...
print("Running Elastic Net ℓ1–ℓ2")
...
print("Running Elastic Net ℓ1–ℓ∞")
