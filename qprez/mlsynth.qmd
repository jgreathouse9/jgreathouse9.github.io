...
- SCM constrains our weights to be on the simplex, $\Delta \operatorname{:=} \{\lVert \mathbf{w} \rVert_1 = 1  \mid \mathbf{w} \in \mathbb{R}_{\geq 0}^{N_0}\}.$ The optimization to learn the weights is  
  $$
...
- Convex SCM favors sparse solutions, but what if the true vector of weights is not mostly 0?
