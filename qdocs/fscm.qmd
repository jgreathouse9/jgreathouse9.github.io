...
This finds the weights $\mathbf{w}$ that minimize the squared error between the treated unit's pre-treatment outcomes and the synthetic control’s weighted average of control units. The space of synthetic control weights is the $N_0$-dimensional probability simplex:
