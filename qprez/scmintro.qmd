...
When we run the optimization, we get that Basque Country is best reproduced by 85% Catalonia and 15% Madrid. The plot below shows how the prediction changes given a chagne in the unit weights that were selected.
