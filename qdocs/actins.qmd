...
$$
\min_{\mathbf{m} \in \Delta_K} \left\| \mathbf{y}_1 - \mathbf{A} \mathbf{m} \right\|_2
$$
...
print("Pre-treatment RMSE:", rmse_pre_treatment)
...
plt.plot(time_points, y_observed, label="Observed Time Series", color="black", linewidth=2)
plt.plot(time_points, cf_final, label="Model-Averaged Counterfactual", linestyle="dashed", color="red", linewidth=2)

# Mark the intervention point
plt.axvline(x=num_pre_periods - 1, color="blue", linestyle="dash", label="Uber")

# Labels and legend
plt.xlabel("Time")
plt.ylabel("New Drivers")
plt.title("Sayulita vs. Counterfactual Sayulita")
plt.legend()
