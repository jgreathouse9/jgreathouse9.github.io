...
$$  
The weight vector $\mathbf{w}$ assigns weights to each of the $N_0$ control units

$$
\mathbf{w} = \begin{bmatrix} w_1 & w_2 & \cdots & w_{N_0} \end{bmatrix}^\top,
$$  
where $w_i$ represents the weight assigned for control unit $i$.
...
Either way, this is how to use the $\ell_2$ relaxer to estimate causal impacts. Check our Zhentao and Yishu's paper for the technical econometric theory and justification. And, you know [where to find me](https://jgreathouse9.github.io/) should you have questions.
